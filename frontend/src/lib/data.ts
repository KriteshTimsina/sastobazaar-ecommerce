// Dummy data for the e-commerce site
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Complete kitchen cookware set with non-stick coating for easy cooking and cleaning.",
    price: 89.99,
  ...
  },
  {
    id: "9",
    name: "Yoga Mat",
    description: "Non-slip yoga mat with excellent cushioning and support for all types of yoga practices.",
    price: 29.99,
    category: "sports",
    image: "/placeholder.svg?height=300&width=300",
    rating: 4.3,
  ...
  },
  {
    id: "10",
    name: "Coffee Maker",
    description: "Programmable coffee maker with 12-cup capacity and built-in grinder for fresh coffee.",
    price: 149.99,
    category: "home-kitchen",
    image: "/placeholder.svg?height=300&width=300",
    rating: 4.6,
  ...
  },
  {
    ...
    description: "Hydrating face cream with natural ingredients for all-day moisture and protection.",
    price: 34.99,
    category: "beauty",
    image: "/placeholder.svg?height=300&width=300",
    rating: 4.4,
...
export function getRelatedProducts(productId: string, category: string, limit = 4): Product[] {
  ...
  const categoryProducts = products.filter(product => product.category === category && product.id !== productId);

  // If we don't have enough products in the same category, add some from other categories
  if (categoryProducts.length < limit) {
    const otherProducts = products.filter(product => product.category !== category && product.id !== productId);
