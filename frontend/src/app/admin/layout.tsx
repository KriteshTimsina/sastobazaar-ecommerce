...
import { BarChart, Box, Home, Package, Settings, ShoppingCart, Users, Package2 } from "lucide-react"
      ...
      <div className="flex flex-1">
        <aside
          className={cn(
            ...
            isMobileMenuOpen ? "block fixed inset-y-0 z-50 bg-background pt-16" : "hidden",
          )}
        >
