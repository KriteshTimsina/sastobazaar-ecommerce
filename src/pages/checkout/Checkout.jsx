...
const Checkout = () => {
  ...
  const placeOrder = (e) => {
    ...
    if (validateForm()) navigate("/checkout/success");
  };
            ...
            <div className="flex flex-col sm:flex-row ">
              ...
              <div>
                <input
                  ...
                  className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/2 focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                  placeholder="ZIP"
                />
