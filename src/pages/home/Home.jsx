...
const Home = () => {
  return (
    <div className="pt-16 dark:bg-darkbg min-h-screen dark:text-darktext ">
      <Swiper />
      <div className="mt-4 w-full mx-auto  flex flex-wrap sm:gap-2.5 justify-center items-center">
        <section className="flex flex-col relative">
          ...
          />
          <div className="absolute bottom-1/4  md:bottom-1/3  text-white text-xl text-center w-full flex flex-col gap-4 items-start pl-5 md:items-center">
            <h1 className="text-2xl">Womenswear</h1>
            <Link
              to="/product"
              className="bg-white text-black px-2 py-1 rounded-sm hover:bg-primary hover:scale-105 hover:text-white transition-all"
            >
              SHOP NOW
            </Link>
          </div>
      ...
      <div className="flex flex-col items-center mb-8">
        <h2 className="text-3xl font-bold uppercase italic">Sasto Bazaar</h2>
