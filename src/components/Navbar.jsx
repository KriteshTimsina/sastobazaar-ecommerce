          ...
          <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark-bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <NavLink
                ...
                to="/cart"
                className="block py-2 pl-3 pr-4 rounded text-w hover:bg-gray-100 md:hover-bg-transparent md:border-0 md:hover-text-blue-700 md:p-0 dark:text-white md:dark-text-blue-500 dark-bg-gray-700 dark-text-white md:dark-bg-transparent"
              >
                Cart
              </NavLink>
            </li>
